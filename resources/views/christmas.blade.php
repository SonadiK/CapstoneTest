...
<div class="album py-5 bg-light">
        ...
        <h3> 
            ...
            <table>  
                ...
                <p style="text-align:center">{{$chris->premade_cake_name}} 
              <!-- </br> with Donut Munchkins -->
            </p>
                
              <p style="text-align:center"> ${{$chris->price}}</p>
              <div style="text-align:center">
              <form action="{{url('add_cart', $chris->id)}}" method="Post">
                @csrf
