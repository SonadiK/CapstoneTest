    ...
    <div class="album py-5 bg-light">
        ...
        <h3> 
            ...
            <table>  
                ...
                <p style="text-align:center">{{$val->premade_cake_name}} 
              <!-- </br> with Donut Munchkins -->
            </p>
                
              <p style="text-align:center"> ${{$val->price}}</p>
              <div style="text-align:center">
              <form action="{{url('add_cart', $val->id)}}" method="Post">
                @csrf
