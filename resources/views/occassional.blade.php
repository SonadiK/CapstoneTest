...
@section('content')
    ...
    <div class="album py-5 bg-light">
        ...
        <h3> 
            ...
            <a class="cake-links" href="/christmas"><strong>Christmas</strong></a>
            <a class="cake-links" href="/graduation"><strong>Graduation</strong></a>
            <a class="cake-links" href="/wedding"><strong>Wedding</strong></a>
            <a class="cake-links" href="/valentine"><strong>Valentine</strong></a>
        </h3>

        <!-- <select onchange="window.location.href=this.value;">
  <option value="/birthday">Birthday Page</option>
